    ...
    <main class='section -intro'>
      <section class='parallax-background -levelSelection'>
        <article class='levels-selection'>
          <a
            onClick={() => props.router.push('/interactive-resume/about')}
            class='level -about'
          ...
          <a
            onClick={() => props.router.push('/interactive-resume/skills')}
            class='level -skills'
          ...
          <a
            onClick={() => props.router.push('/interactive-resume/experience')}
